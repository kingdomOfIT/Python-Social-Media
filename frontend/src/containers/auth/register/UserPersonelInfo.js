...
const UserPersonalInfo = ({ nextPage, previousPage, handleSubmit }) => {
    return (
        <Fragment>
                ...
                <form onSubmit={handleSubmit(nextPage)} className="animated wow fadeIn">
                    ...
                    <div className="centered-content">
                        <div className="centered-content-inner">
                            <button onClick={previousPage} className="btn btn-general mt-3 btn-login">
                                Previous
                            </button>
                            <button type="submit" className="btn btn-general mt-3 btn-login">
                                Next
                            </button>
                        </div>
                    </div>
