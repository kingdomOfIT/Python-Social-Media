...
export class LikedPost extends Component {
    ...
    componentDidMount() {
        ...
        if (userId) {
            console.log("Inside")
            const savedPosts1 = this.props.getUserLikedPosts(userId, () => {});
    ...
    renderPosts(){
        ...
        console.log("Post: ", postsReducer)
        console.log("LIKED POST: ", postsReducer.likedPosts)

        return postsReducer.likedPosts && postsReducer.likedPosts.map(post => {
...
const mapStateToProps = (state) => ({
  ...
  export default withStyles(styles)(withRouter(connect(mapStateToProps, { getUserLikedPosts })(LikedPost)));
